...
<div class="container">
	...
	<?php	 if (($_POST['mA'] == $_POST['nB'])){?>
			<form method="POST" action="oper_produit.php">
	...
	<?php		}?>
			...
			<?php }
					...
					echo "désolé, les deux matrice doivent respecter les consignes";?>
					<p><br /> Cliquer <a href="../index.php"><strong>ici</strong></a> pour revenir au menu</p>
			<?php		
				}
			?>
	</div>
